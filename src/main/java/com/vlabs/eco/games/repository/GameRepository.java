...
public interface GameRepository extends CrudRepository<Game, Long> {
    ...
    default List<Game> findGamesByYear(String teamName, LocalDate date1, LocalDate date2) {
        return getByTeam1AndDateBetweenOrTeam2AndDateBetweenOrderByDateDesc(teamName, date1, date2,
